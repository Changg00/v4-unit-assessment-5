...
class Auth extends Component {
  ...
  async register() {
  const { username, password } = this.state
  const profile_pic = `https://static.wikia.nocookie.net/community-sitcom/images/c/c1/Chang_S5_headshot.jpg/revision/latest/scale-to-width-down/340?cb=20140101080218/${username}.png`
  try {
